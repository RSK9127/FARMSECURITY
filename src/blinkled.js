...
import bulb_on from './animations/water.webp';
import bulb_off from './animations/motoroff.jpg';
...
const BulbPage = ({ onClose }) => {
  ...
  const handleToggle = () => {
    ...
    const apiUrl = 'http://192.168.1.117:5000/watermotor'; // Replace with your Flask API endpoint
